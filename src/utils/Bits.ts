...
export class Bits {
     ...
     * @return this
     */
    public and(other: Bits) {
        const commonWords = Math.min(this.data.length, other.data.length);
